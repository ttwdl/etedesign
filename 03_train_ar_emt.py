...
USER_SETTINGS = {
    ...
    "checkpoint_dir": "checkpoints_36ch_t06_tor15_150",
    "results_dir": "results_36ch_t06_tor15_150",
    "tensorboard_dir": "runs/ar_emt_36ch_t06_tor15_150",
    ...
    # ---- 训练规模 ----
    "epochs": 150,         # 这次从 50 轮 checkpoint 继续跑到 150 轮
    "batch_size": 512,
    ...
    "n_channels": 36,              # 36 个滤光片，对应 6x6 超像素；光谱测量最多，但空间分辨率损失最大
    "hidden_dims": (1024, 512),    # 36 通道版本使用更宽的 MLP 解码器
