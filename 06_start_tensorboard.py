...
用法：
  1. 先跑 03_train_ar_emt.py，它会把日志写到 runs/ar_emt_live；
  2. 再跑本脚本:
       & 'C:\\Users\\23\\.conda\\envs\\TMM\\python.exe' 06_start_tensorboard.py
  3. 浏览器打开下面提示的地址（默认 http://localhost:6009）。
...
# =============================================================================
USER_SETTINGS = {
    "logdir": "runs/ar_emt_live",   # 要和 03_train_ar_emt.py 的 tensorboard_dir 一致
    "port": 6009,
}
